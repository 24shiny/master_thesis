...
for idx = 1:r %e
    ...
    for jdx = 1:r %j
        for kdx = 1:r %k
            m1(jdx,kdx) = exp(-temp_e*(t(jdx)-t(kdx)));
        end
    end
    M1{idx} = m1;
    m1 = zeros(r);
...
as = [0.0001, 0.00001, 0.00005];
[c1,delta1,f1,ind1] = gradient_descent_f4(M1,m5,e,t,r,tau,omega,x_1,as(1),MAX_ITERS); 
[c2,delta2,f2,ind2] = gradient_descent_f4(M1,m5,e,t,r,tau,omega,x_1,as(2),MAX_ITERS); 
[c3,delta3,f3,ind3] = gradient_descent_f4(M1,m5,e,t,r,tau,omega,x_1,as(3),MAX_ITERS); 
